...
export default function ServicesSection() {
  return (
    <section className="py-24 bg-[#fcf9f8]" id="services">
      <div className="max-w-[1280px] mx-auto px-4 md:px-16">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-[16px] text-[#43474e] leading-relaxed">
            Areas that directly impact how a business grows, scales, and sustains long-term success through structured processes and technology.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Service Card 3 (Row Span 2 - Sales & Lead Follow-Up with sales.png) */}
          ...
          {/* Service Card 6 (Customer Support - 2 Cards Width) */}
